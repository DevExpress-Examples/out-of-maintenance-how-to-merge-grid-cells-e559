...
Namespace WindowsApplication93
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.gridControl1.Size = New System.Drawing.Size(556, 338)
			...
			' dataColumn1
			' 
			Me.dataColumn1.ColumnName = "CategoryID"
			Me.dataColumn1.DataType = GetType(Integer)
			' 
			' dataColumn2
			' 
			Me.dataColumn2.ColumnName = "ProductName"
			' 
			' dataColumn3
			' 
			Me.dataColumn3.ColumnName = "VendorID"
			Me.dataColumn3.DataType = GetType(Integer)
			' 
			' gridView1
			' 
			Me.gridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() { Me.colCategoryID, Me.colProductName, Me.colVendorID})
...
'			Me.Load += New System.EventHandler(Me.Form1_Load);
		...
		Private colVendorID As DevExpress.XtraGrid.Columns.GridColumn
	End Class
End Namespace
